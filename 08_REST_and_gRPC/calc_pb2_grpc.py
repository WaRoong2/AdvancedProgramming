...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Calc = channel.unary_unary(
                '/Calculator/Calc',
                request_serializer=calc__pb2.Operands.SerializeToString,
                response_deserializer=calc__pb2.CalcResult.FromString,
                )
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Calc': grpc.unary_unary_rpc_method_handler(
                    servicer.Calc,
                    request_deserializer=calc__pb2.Operands.FromString,
                    response_serializer=calc__pb2.CalcResult.SerializeToString,
            ),
    }
...
class Calculator(object):
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Calculator/SayHello',
    ...
    def Calc(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Calculator/Calc',
            calc__pb2.Operands.SerializeToString,
            calc__pb2.CalcResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
